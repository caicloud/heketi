...
func (s *CaiExecutor) PeerProbe(host, newnode string) error {
...
func (s *CaiExecutor) PeerDetach(host, detachnode string) error {
	godbc.Require(host != "")
...
func (s *CaiExecutor) GlusterdCheck(host string) error {
	godbc.Require(host != "")
