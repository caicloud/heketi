...
func (s *RawExecutor) PeerProbe(host, newnode string) error {
...
func (s *RawExecutor) PeerDetach(host, detachnode string) error {
	godbc.Require(host != "")
...
func (s *RawExecutor) GlusterdCheck(host string) error {
	godbc.Require(host != "")
